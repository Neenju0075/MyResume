...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  ...
  \href{https://www.niranjanan.co.nf}{www.niranjanan.co.nf}  & Mobile : +91-9566478282 \\
\end{tabular*}
  \begin{center}
    ...
    \resumeSubheading
	 ...
	 {Worked on a various Products and Services - Utility and Payment Data service, Auto-monitoring + Ticketing, and automation of various processes from acquisition to delivery.}
          ...
          {\textbf{Technologies \& Frameworks Used}: Java, Play for Java, SpringBoot, Hibernate, SQL, Unix scripts.}
           \resumeItemWithoutColon{}
          {\textbf{Tools Used}: Gradle, Jenkins, Ansible, Activator for play, Maven, Kinesis, SQS, LEX, Lambda, JIRA, Slack, Confluence}
      \resumeItemListEnd
...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {B.E - Computer Science and Engineering;  CGPA: 8.1}{May 2012 -- June 2016}
  \resumeSubHeadingListEnd
...
\section{Programming Skills}
  \resumeSubHeadingListStart
    \item{
     ...
     %   \\[0.1in] %2-line-break
    \item
      \textbf{Technologies}{: Spring-boot, Play for Java, Hibernate, JPA, AWS, Basics of HTML and css}
    }
  \resumeSubHeadingListEnd
